...
export const CATEGORIES = [
  ...
  { id: 'Ears',          label: 'Ears',        select: 'single', required: true },
  { id: 'Face',          label: 'Face',        select: 'single', required: true },
  { id: 'HairFront',     label: 'Hair',        select: 'single', required: true },
  { id: 'Eyes',          label: 'Eyes',        select: 'single', required: true },
  { id: 'Brows',         label: 'Eyebrows',    select: 'single', required: true },
  { id: 'Nose',          label: 'Nose',        select: 'single', required: true },
  { id: 'Mouth',         label: 'Mouth',       select: 'single', required: true },
  { id: 'Beard',         label: 'Beard',       select: 'single', required: false },
...
export const TEXT_FIELDS = [
  ...
  { id: 'code',        label: 'Code',        x: 1990, y: 2150, fontSize: 78,  maxLength: 24, align: 'left' },
];
